...
let patna_link = `http://api.weatherapi.com/v1/current.json?key=32f1d3c0461b4c8592b155802222511&q=patna`;
let agra_link = `http://api.weatherapi.com/v1/current.json?key=32f1d3c0461b4c8592b155802222511&q=agra`;
let kolkata_link = `http://api.weatherapi.com/v1/current.json?key=32f1d3c0461b4c8592b155802222511&q=kolkata`;
let del_link = `http://api.weatherapi.com/v1/current.json?key=32f1d3c0461b4c8592b155802222511&q=delhi`;
...
searchBtn.addEventListener("click", async () => {
    ...
    let link = `http://api.weatherapi.com/v1/current.json?key=32f1d3c0461b4c8592b155802222511&q=${string}`;
