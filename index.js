...
if (location.protocol === "http:") {
    ...
    link = `https://api.weatherapi.com/v1/current.json?key=32f1d3c0461b4c8592b155802222511&q=patna`;
}
...
if (location.protocol === "http:") {
    ...
    link = `https://api.weatherapi.com/v1/current.json?key=32f1d3c0461b4c8592b155802222511&q=agra`;
}
let kolkata_link = "";
if (location.protocol === "http:") {
    patna_link = `http://api.weatherapi.com/v1/current.json?key=32f1d3c0461b4c8592b155802222511&q=kolkata`;
}
else{
    link = `https://api.weatherapi.com/v1/current.json?key=32f1d3c0461b4c8592b155802222511&q=kolkata`;
}

let del_link = "";
if (location.protocol === "http:") {
    patna_link = `http://api.weatherapi.com/v1/current.json?key=32f1d3c0461b4c8592b155802222511&q=delhi`;
}
else{
    link = `https://api.weatherapi.com/v1/current.json?key=32f1d3c0461b4c8592b155802222511&q=delhi`;
}
...
async function delhiFunction() {
    ...
    // console.log(del_data.current.temp_c);
